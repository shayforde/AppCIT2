 ...
 */
public class LinkCareerCounselling extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webSettings.setBuiltInZoomControls(true);
        mWebview.loadUrl("http://192.168.1.102/joomla/index.php/su-and-services/105-careers-and-counselling");
